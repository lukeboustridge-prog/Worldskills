...
Output: Library installation, search page with URL params, debounced search input, filter components synced to URL
</objective>
...
<task type="auto">
  <name>Task 4: Create filter panel with URL sync</name>
...
Create `src/app/descriptors/components/DescriptorList.tsx`:
...
All filters combine in URL: ?q=safety&skill=Welding&page=2
  ...
  <done>Filter panel, pagination, and descriptor list components created, all synced to URL state</done>
</task>
